...
I’m a Computer Science student focused on building **practical AI applications** that solve real-world problems.  
My interests lie in **Natural Language Processing, Computer Vision, and RAG**, I enjoy taking ideas from concept → working product.
...
Hybrid NLP system (DistilBERT + ML) for error detection and classification  

---

### 📊 Meetric – Meeting Intelligence Hub  
Extracts summaries, insights, and action items from meetings  

---

### 🔊 Invora – Inventory System  
Processes user input into structured inventory actions using NLP  
